	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      <div class="modal-body">
	        	...
	        	{{-- <img src="{{ $publicPath }}images/header_q.png"> --}}
	        	<div class="modal-f">
	        		<button class="btn-coupon" type="submit" onclick="completed()">
						{{-- <img src="{{ $publicPath }}images/btn-coupon.png" class=""> --}}
						<img src="{{ $publicPath }}images/btn-coupon-a.png" id="addCoupon">
					</button>
	        	</div>
	      </div>
	    </div>
