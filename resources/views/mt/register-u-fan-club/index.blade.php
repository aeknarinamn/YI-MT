		...
		<div class="register register_u_point">
			<div class="col-md-12 col-sm-12 np">
				<div class="header_top">
					<ul >
						<li class="first-item have-stamp"> <img src="/mt-rev2/img/upoint.png"> </li>
					</ul>
							...
							<form id="action-form" action="{{ action('MT\EstampController@storeRegisterData') }}" method="post">
								...
								<input type="hidden" name="code" value="{{$code}}">
							  	<div class="form-group">
								    ...
								    <input type="text" class="form-control input_register" id="name" name="first_name">
							  	</div>
							  	<div class="form-group">
								    <label for="surname">นามสกุล*</label>
								    <input type="text" class="form-control input_register" id="surname" name="last_name">
							  	</div>
								<div class="form-group">
							  	...
							  	<div class="form-group">
								    <label for="product">ประเภทสินค้าที่คุณซื้อบ่อยที่สุด ที่เทสโก้โลตัส*</label>
								...
								<div class="condition">กดดูเงื่อนไข <span> <a href="http://www.unileverprivacypolicy.com/thai/policy.aspx" target="_blank">ที่นี่</a> </span></div>
							</form>
						</div>
					</div>
				</div>
			...
			<div class="footer">
				<div class="row">
					<div class="col-md-6 col-md-offset-3 col-sm-10 col-sm-offset-1">
						<a href="#" onclick="validate(); return false;" class="backbutton"> <img src="/mt-rev2/img/backbutton.png"> </a>
					</div>
				</div>
			</div>
		</div>
